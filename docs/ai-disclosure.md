...
| 15 | 3 September 2026 | Graded A2 against the rubric, checked every calculation, and edited the writing for grammar |
| 16 | 3 September 2026 | Member length and internal force table added under the final model |
| 17 | 3 September 2026 | Two superseded calculation sheets swapped out, the pin weight sheet added |
| 18 | 3 September 2026 | The page rendered to PDF for submission |
...
## A3 — Axial Deflection and FEA

Claude was used to lay out this page — placing the figures, writing the image captions, and adding the front matter that drives the homepage card. The design, the hand calculations, the CAD models and the FEA runs are mine; no engineering content was produced by the model.
