...
I wanted to compare this to a design with no central members so I redid the calculations for the figure pictured above. doing this I was able to show that the forces through AB, BC, CD, and AD were the same across the two designs. I had proven that the central members weren't doing anything when not factoring bending into things.
