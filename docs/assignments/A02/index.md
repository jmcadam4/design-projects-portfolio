...
<figure style="margin:1.6em 0; text-align:center;">
  <img src="Screenshot%202026-09-03%20085436.png" width="537" height="500" alt="Pin sized in single shear on the largest member force — symbolic, then numeric, giving d = 13.46 mm" style="width:100%; max-width:720px; height:auto; display:block; margin:0 auto; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;">
  <figcaption style="margin-top:.6em; font-size:.75rem; line-height:1.45; color:var(--md-default-fg-color--light);">Pin sized in single shear on the largest member force — symbolic, then numeric, giving d = 13.46 mm</figcaption>
</figure>

<figure style="margin:1.6em 0; text-align:center;">
  <img src="Screenshot%202026-09-03%20085443.png" width="667" height="350" alt="Minimum element cross-section solved symbolically as A = nFₘₐₓ/σ, then evaluated at 634.06 mm²" style="width:100%; max-width:720px; height:auto; display:block; margin:0 auto; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;">
