...
### Material Properties and Hand Calculations
...
### Square Bar CAD and Static Study
...
<div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(300px,1fr)); gap:1rem 1.1rem; align-items:start; margin:1.6em 0;"><figure style="margin:0;"><img src="Screenshot%202026-09-09%20205611.png" width="802" height="791" alt="Cylindrical, with safety factor — 57.045 MPa" style="width:100%; height:auto; display:block; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;"><figcaption style="margin-top:.45em; font-size:.72rem; line-height:1.4; text-align:center; color:var(--md-default-fg-color--light);">Cylindrical, with safety factor — 57.045 MPa</figcaption></figure><figure style="margin:0;"><img src="Screenshot%202026-09-09%20205635.png" width="800" height="827" alt="Cylindrical, without safety factor — 56.517 MPa" style="width:100%; height:auto; display:block; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;"><figcaption style="margin-top:.45em; font-size:.72rem; line-height:1.4; text-align:center; color:var(--md-default-fg-color--light);">Cylindrical, without safety factor — 56.517 MPa</figcaption></figure><figure style="margin:0;"><img src="Screenshot%202026-09-09%20205704.png" width="757" height="842" alt="Square prism, with safety factor — 62.941 MPa" style="width:100%; height:auto; display:block; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;"><figcaption style="margin-top:.45em; font-size:.72rem; line-height:1.4; text-align:center; color:var(--md-default-fg-color--light);">Square prism, with safety factor — 62.941 MPa</figcaption></figure><figure style="margin:0;"><img src="Screenshot%202026-09-09%20205648.png" width="733" height="808" alt="Square prism, without safety factor — 61.714 MPa" style="width:100%; height:auto; display:block; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;"><figcaption style="margin-top:.45em; font-size:.72rem; line-height:1.4; text-align:center; color:var(--md-default-fg-color--light);">Square prism, without safety factor — 61.714 MPa</figcaption></figure></div>
...
<figure style="margin:1.6em 0; text-align:center;">
  <img src="Screenshot%202026-09-09%20213452.png" width="705" height="427" alt="The Onshape variable table — E, Y, dL, F and sf entered as inputs, with area, length and diameter solved from them" style="width:100%; max-width:700px; height:auto; display:block; margin:0 auto; border:1px solid var(--md-default-fg-color--lightest); border-radius:6px;">
